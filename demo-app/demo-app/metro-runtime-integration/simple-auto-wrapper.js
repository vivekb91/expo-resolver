/**
 * Simple Metro Auto-Wrapper Plugin
 * 
 * A simplified version that avoids template string issues
 */
...
/**
 * Apply auto-wrapper plugin to Metro config
 */
function applyAutoWrapperPlugin(baseConfig, options = {}) {
  const {
    modules = [],
    platforms = ['web', 'dom'],
    resolverConfig = {
